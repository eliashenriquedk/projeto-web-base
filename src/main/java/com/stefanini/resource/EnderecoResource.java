...
public class EnderecoResource {
	...
	@GET
    @Path("/enderecos-pessoa/{id}")
    public Response buscarSePessoaPossuiEndereco(@PathParam("id") Long id) {
        return Response.ok(enderecoServico.buscarSePessoaPossuiEndereco(id).get()).build();
    }
}
